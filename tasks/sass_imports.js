 ...
 *
 * Copyright (c) 2013 Michael Frank
...
module.exports = function(grunt) {
	...
	grunt.registerMultiTask('sass_imports', 'A grunt task to create @import statements from a collection of stylesheet files.', function() {
		var css = '',
			sassImports = '',
			// Merge task-specific and/or target-specific options with these defaults.
			options = this.options({
				inlineCSS: true,
				banner: '// This file was generated by grunt-sass-imports'
			}),
		...
		grunt.file.write(dest, banner + css + sassImports);
